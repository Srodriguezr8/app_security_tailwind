...
group_module_permission=GroupModulePermission.objects.select_related('module_menu').annotate(cant_modulos_activos=Count('moduleis_active')).filter(cant_modulos_activosgt=0,groupid=1,moduleis_active=True).values('modulemenuid','modulemenu_name','cant_modulos_activos')
